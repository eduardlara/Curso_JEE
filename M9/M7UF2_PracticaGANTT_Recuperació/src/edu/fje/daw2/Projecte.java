...
public class Projecte implements Serializable {
    ...
    private String name;
    private int codi;
    private ArrayList<Tasca> llistaTasques;

    public Projecte(String name, int codi, int desc, Date dini, Date dfin) {
        this.dini = dini;
        this.dfin = dfin;
        ...
        this.name = name;
        this.codi = codi;
        this.llistaTasques = new ArrayList<Tasca>();
    }
    public Projecte(String name, int codi, int desc, long dini, long dfin) {
        this.data_ini = dini;
        this.data_fin = dfin;
    ...
    public ArrayList<Tasca> getLlistaTasques() {
